...
(function($){
	...
	SEMICOLON.header = {
		...
		sideHeader: function(){
			...
			$("#inner-header-trigger").click(function(){
                $('body.open-header').toggleClass("side-header-open");
                return false;
            });
		},
		...
		windowscroll: function(){
			...
			$window.on( 'scroll', function(){
				...
				if (window.scrollY > 30 ) {
					$('.side-header.open-header #header-trigger').addClass('scrolled');
				} else {
					$('.side-header.open-header #header-trigger').removeClass('scrolled');
				}
